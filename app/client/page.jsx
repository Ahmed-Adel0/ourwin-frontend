        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full max-w-md px-6 py-3 bg-gray-900 border border-gray-800 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#45B7BA] transition-colors"
                ...
                >
                  ...
                  <div className="relative w-full h-full">
                    <Image
                      ...
                      alt={client.name}
                      fill
                      className="object-contain grayscale contrast-200 group-hover:grayscale-0 transition-all duration-300"
                    />
                  </div>
