...
const ProjectsCarousel = ({
  ...
  return (
    <div className="w-full h-full flex flex-col min-h-[300px]">
      <div className="w-full h-full relative bg-gradient-to-r from-[#02141f] via-[#031c29] to-[#02141f] rounded-2xl border border-[#45B7BA]/20 px-4 sm:px-5 md:px-6 py-5 sm:py-6 shadow-[0_18px_60px_rgba(0,0,0,0.8)]">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl md:text-2xl font-bold text-white uppercase tracking-wide">
            PROJECTS
        ...
        <div className="relative flex-grow">
          ...
          {canScrollLeft && (
            <button
              ...
              className="absolute hover:cursor-pointer left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-[#0b253b] border border-[#45B7BA]/30 hover:border-[#45B7BA] text-white flex items-center justify-center transition-all hover:bg-[#45B7BA]/10"
          ...
          >
            {projects.map((project, index) => (
              <Link
                ...
                className="group flex-shrink-0 w-[90vw] sm:w-[75vw] md:w-[calc(50%-1rem)] lg:w-[calc(50%-1.5rem)] snap-center)]"
              >
                <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-[#0b253b] border border-[#45B7BA]/20 hover:border-[#45B7BA] transition-all duration-300 shadow-lg shadow-teal-900/50">
                  {project.imageUrl ? (
                    <Image
                      ...
                      fill
                      className="group flex-shrink-0 h-[90%] object-cover transition-transform duration-500 group-hover:scale-110"
                    />
                  ) : (
          ...
          {canScrollRight && (
            <button
              ...
              onMouseEnter={checkScrollability}
              className="absolute hover:cursor-pointer right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-[#0b253b] border border-[#45B7BA]/30 hover:border-[#45B7BA] text-white flex items-center justify-center transition-all hover:bg-[#45B7BA]/10"
