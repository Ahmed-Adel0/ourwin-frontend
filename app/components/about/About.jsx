        ...
        <div className="grid md:grid-cols-2 md:gap-6  items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="mb-6 text-base text-gray-300 leading-relaxed">
              Outwin is a full-scale marketing agency specializing in: Digital
              Marketing, Branding & Identity, Media Production, Content
              Creation, Social Media Management, SEO, and Web Development. We
              combine strategy, creativity, and performance to create solutions
              that move the needle — helping startups and SMEs scale, stand out,
              and lead in today’s competitive digital market. Whether you're
              launching a brand, boosting sales, or expanding to the Gulf
              market, our mission is simple: Deliver results. Every time.
            </p>
          ...
          <div className="order-1 md:order-2 hidden md:block">
            <div className="relative w-full aspect-square max-w-md mx-auto md:ml-auto md:mr-0">
              <Image
                ...
                className="transition-transform duration-500 hover:scale-[1.05] hover:cursor-pointer"
              />
            </div>
          </div>
        </div>
