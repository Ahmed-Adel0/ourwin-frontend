  ...
  return (
    <section className="w-full pt-24 pb-12 bg-black px-4">
      ...
      <div className="relative w-full min-h-[80vh] flex items-center justify-start rounded-2xl overflow-hidden bg-[#0b253b] shadow-2xl shadow-cyan-900/50 mt-6 mb-12">
        ...
        {/* المحتوى محدود بـ ContentWrapper */}
        <ContentWrapper>
          <div className="relative z-10 text-white max-w-4xl">
            ...
            <Link
              href="/services"
              className="bg-[#45B7BA] text-[#052636] font-bold py-4 px-8 rounded-lg text-lg hover:bg-[#2c989c] transition-colors duration-300 shadow-xl"
            >
              Start Your Project
            </Link>
          </div>
